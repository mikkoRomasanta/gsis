...
@section('content')
    <div class="container h-100">
        ...
        <h3 class="text-center" style="margin: 0px">Add Stocks</h3>
    </div><hr>
    <div class="container">
        {{ Form::open(['action' => ['ReceivingsController@storeMulti'], 'method' => 'POST', 'name' => 'receive_stocks']) }}
            <table class="table table-sm table-bordered text-center" id="tbl-receive">
                ...
                <tr>
                    ...
                    <td>{{Form::text('received_by[]', Auth::user()->username,['class' => 'form-control', 'placeholder' => 'name', 'readonly'])}}</td>
                    <td></td>
                </tr>
            </table>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(document).on("change", "#item_id", function(){	// change uom based on item
                val = $(this).val();
                uomBox = $(this).closest('tr').find('#uom');
